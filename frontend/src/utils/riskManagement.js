...
// This utility determines when odds should be disabled to reduce risk

/**
 * Risk thresholds for different types of bets
 */
export const RISK_THRESHOLDS = {
  // Minimum odds allowed (below this is too risky)
  MIN_ODDS: 1.10,
  
  // Maximum odds allowed (above this is okay - not considered risky)
  MAX_ODDS: 50.0,
  
  // Live match risk multiplier (live matches are riskier)
  LIVE_RISK_MULTIPLIER: 1.5,
  
  // Score difference threshold for live matches
  LIVE_SCORE_DIFFERENCE_THRESHOLD: 3,
  
  // Time remaining threshold for live matches (last 10 minutes)
  LIVE_TIME_THRESHOLD_MINUTES: 10,
  
  // Obvious outcome thresholds
  OBVIOUS_WIN_THRESHOLD: 1.10, // Below 1.10 odds are too obvious
  OBVIOUS_LOSS_THRESHOLD: 50.0, // Above 50 odds are okay
};
...
export const isLiveMatchObvious = (match) => {
  ...
  // Check if there's a significant score difference
