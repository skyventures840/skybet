...
const MARKET_MAPPING = {
  ...
  player_points: { standardizedHeader: 'Points', category: 'Player Props', supportedSports: 'NBA, NCAAB, WNBA, NHL' },
  ...
  // player_points: { standardizedHeader: 'Points', category: 'Player Props', supportedSports: 'NHL' }, // Merged with Basketball
  ...
  player_goal_scorer_anytime: { standardizedHeader: 'Anytime Goal Scorer', category: 'Player Props', supportedSports: 'NHL, Soccer' },
  // Alternates: e.g., 'player_points_alternate': { standardizedHeader: 'Alternate Points', category: 'Player Props', supportedSports: 'NHL' }

  // Player Props - Soccer
  // player_goal_scorer_anytime: { standardizedHeader: 'Anytime Goal Scorer', category: 'Player Props', supportedSports: 'Soccer' }, // Merged with NHL
